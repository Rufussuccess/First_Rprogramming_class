library("readr")
path <- "C:/Users/USER/Downloads/archive/diabetes.csv"
df <- read_csv(path)
View(df)
...
path2 <- "C:/Users/USER/Desktop/Brewery_data.csv"
df2 <- read.csv(path2)
View(df2)
...
path_val<- "C:/Users/USER/Desktop/Brewery_data.csv"
